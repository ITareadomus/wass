...
NEARBY_DISTANCE_KM = 0.50          # km: soglia per considerare due apt "molto vicini" (500m, aumentato per catturare più cluster)
...
SAME_BUILDING_BONUS = -8           # bonus per stessa via (include stesso edificio e blocco vicino) - aumentato
NEARBY_CLUSTER_BONUS = -20         # bonus forte per appartamenti molto vicini geograficamente (aumentato per priorità clustering)
