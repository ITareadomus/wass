      ...
      >
        <DialogContent className="sm:max-w-md">
          ...
          <Textarea
            ...
            className="mt-2 min-h-[120px] resize-none cursor-default whitespace-pre-wrap break-words border-slate-600 bg-slate-950 text-slate-50 focus-visible:ring-0 focus-visible:ring-offset-0"
          />
