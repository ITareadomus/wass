...
export default function AssignmentsTimeline({ 
  ...
  return (
    <div className="bg-card rounded-lg border shadow-sm mt-8" style={{ width: 'fit-content' }}>
      <div className="p-4 border-b border-border">
        <h3 className="font-semibold text-foreground flex items-center">
          <Calendar className="w-5 h-5 mr-2 text-primary" />
          Timeline Temporale (8:00 - 19:00)
        </h3>
      </div>
        ...
        >
          ...
          {cleanerGroups.map((group, groupIndex) => (
            <div key={groupIndex} className="contents">
              ...
              <div 
                className="col-span-12 border border-border relative"
