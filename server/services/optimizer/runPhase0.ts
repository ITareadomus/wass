...
export async function runPhase0(
  ...
  try {
    ...
    const phase0Result: Phase0Result = filterLockedTasks(tasks, { workDate, runId });
    ...
    console.log(`[Phase0] Total: ${result.totalTasks}, Locked: ${result.lockedTasks}, Unlocked: ${result.unlockedTasks}`);
